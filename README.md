...
Figure above shows the relationship between a set of force couples (dipoles and double-couples), radiation pattern generated by these forces, a geometric representation of the radiation pattern called a focal mechanism, and the physical mechanisms (e.g.,) explosions or collapses, earthquakes, and volcanic processes like magma movement in a dike or caldera inflation and deflation. 
