...
# mxx,myy,mzz,mxy,mxz,myz,class,etype_pred,prob_eq,prob_ex,prob_co,lune_lon,lune_lat
# -0.1772,-0.499,0.08557,-0.08883,0.2217,-0.6831,0,eq,1.0,1.7622522e-16,2.6599292e-20,-3.001,-17.165
#
# awk -F, '{print $12, $13,  $9}' ${INPUT}.csv > ${INPUT}.eq
# awk -F, '{print $12, $13, $10}' ${INPUT}.csv > ${INPUT}.ex
# awk -F, '{print $12, $13, $11}' ${INPUT}.csv > ${INPUT}.co
# awk -F, '{print $12, $13,  $7}' ${INPUT}.csv > ${INPUT}.class
#
######################
...
####
psconvert -Tj -E300 -A ${PS}

/bin/rm -f ${PS}
/bin/rm -f prob.cpt points.xy cint.xy
/bin/rm -f ${INPUT}.eq.grd ${INPUT}.co.grd ${INPUT}.ex.grd ${INPUT}.class.grd
/bin/rm -f ${INPUT}.eq ${INPUT}.co ${INPUT}.ex ${INPUT}.class
